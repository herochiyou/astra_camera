...
class Xn16zEmbTablesCodec : public XnCodecBase {
  ...
  virtual XnStatus CompressImpl(const XnUChar *pData, XnUInt32 nDataSize,
    ...
    return XnStreamCompressDepth16ZWithEmbTable(
        (XnUInt16 *)pData, nDataSize, pCompressedData, pnCompressedDataSize,
        m_nMaxValue);
  }
  ...
  virtual XnStatus DecompressImpl(const XnUChar *pCompressedData,
                                  ...
                                  XnUInt32 *pnDataSize) {
    return XnStreamUncompressDepth16ZWithEmbTable(
        pCompressedData, nCompressedDataSize, (XnUInt16 *)pData, pnDataSize);
  }

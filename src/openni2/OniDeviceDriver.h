 ...
 *                                                                            *
 *****************************************************************************/
#ifndef _ONI_IMPL_DEVICE_DRIVER_H_
...
typedef void ONI_CALLBACK_TYPE DeviceStateCallback(Device *, OniDeviceState,
                                                   void *);
...
class DeviceDriver {
  public:
  DeviceDriver(const char *strDriverFileName, FrameManager &frameManager,
  ...
  OniStatus registerDeviceConnectedCallback(DeviceCallback handler,
                                            void *pCookie,
                                            OniCallbackHandle &handle);
  void unregisterDeviceConnectedCallback(OniCallbackHandle handle);
  OniStatus registerDeviceDisconnectedCallback(DeviceCallback handler,
                                               void *pCookie,
                                               OniCallbackHandle &handle);
  void unregisterDeviceDisconnectedCallback(OniCallbackHandle handle);
  OniStatus registerDeviceStateChangedCallback(DeviceStateCallback handler,
                                               void *pCookie,
                                               OniCallbackHandle &handle);
  ...
  driver_DeviceConnected(const OniDeviceInfo *pInfo, void *pCookie);
  static void ONI_CALLBACK_TYPE
...
#endif // _ONI_IMPL_DEVICE_DRIVER_H_
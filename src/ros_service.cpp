...
void OBCameraNode::setupCameraCtrlServices() {
  for (const auto &stream_index : IMAGE_STREAMS) {
    if (!enable_[stream_index] || !device_->hasSensor(stream_index.first)) {
      // ROS_INFO_STREAM("Stream " << stream_name_[stream_index] << " is
      // disabled");
      continue;
    }
    auto stream_name = stream_name_[stream_index];
    std::string service_name = "get_" + stream_name + "_exposure";
    get_exposure_srv_[stream_index] =
        nh_.advertiseService<GetInt32Request, GetInt32Response>(
            service_name, [this, stream_index = stream_index](auto &&request,
                                                              auto &&response) {
              response.success =
                  this->getExposureCallback(request, response, stream_index);
              return response.success;
            });
    service_name = "set_" + stream_name + "_exposure";
    set_exposure_srv_[stream_index] =
        nh_.advertiseService<SetInt32Request, SetInt32Response>(
            service_name, [this, stream_index = stream_index](auto &&request,
                                                              auto &&response) {
              response.success =
                  this->setExposureCallback(request, response, stream_index);
              return response.success;
            });
    service_name = "get_" + stream_name + "_gain";
    get_gain_srv_[stream_index] =
        nh_.advertiseService<GetInt32Request, GetInt32Response>(
            service_name, [this, stream_index = stream_index](auto &&request,
                                                              auto &&response) {
              response.success =
                  this->getGainCallback(request, response, stream_index);
              return response.success;
            });
    service_name = "set_" + stream_name + "_gain";
    set_gain_srv_[stream_index] =
        nh_.advertiseService<SetInt32Request, SetInt32Response>(
            service_name, [this, stream_index = stream_index](auto &&request,
                                                              auto &&response) {
              response.success =
                  this->setGainCallback(request, response, stream_index);
              return response.success;
            });
    ...
    set_mirror_srv_[stream_index] =
        nh_.advertiseService<std_srvs::SetBoolRequest,
            ...
            service_name, [this, stream_index = stream_index](auto &&request,
                                                              auto &&response) {
              response.success =
                  this->setMirrorCallback(request, response, stream_index);
              return response.success;
            });
    ...
    set_auto_exposure_srv_[stream_index] =
        nh_.advertiseService<std_srvs::SetBoolRequest,
            ...
            service_name, [this, stream_index = stream_index](auto &&request,
                                                              auto &&response) {
              response.success = this->setAutoExposureCallback(
                  request, response, stream_index);
              return response.success;
            });
    ...
    toggle_sensor_srv_[stream_index] =
        nh_.advertiseService<std_srvs::SetBoolRequest,
            ...
            service_name, [this, stream_index = stream_index](auto &&request,
                                                              auto &&response) {
              response.success =
                  this->toggleSensorCallback(request, response, stream_index);
              return response.success;
            });
    ...
    get_supported_video_modes_srv_[stream_index] =
        nh_.advertiseService<GetStringRequest, GetStringResponse>(
            service_name, [this, stream_index = stream_index](auto &&request,
                                                              auto &&response) {
              response.success = this->getSupportedVideoModesCallback(
                  request, response, stream_index);
              return response.success;
            });
  }
  get_white_balance_srv_ =
      nh_.advertiseService<GetInt32Request, GetInt32Response>(
          "get_auto_white_balance", [this](auto &&request, auto &&response) {
            response.success = this->getAutoWhiteBalanceEnabledCallback(
                request, response, COLOR);
            return response.success;
          });
  set_white_balance_srv_ =
      nh_.advertiseService<SetInt32Request, SetInt32Response>(
          "set_auto_white_balance", [this](auto &&request, auto &&response) {
            response.success =
                this->setAutoWhiteBalanceEnabledCallback(request, response);
            return response.success;
          });
  set_fan_enable_srv_ =
  ...
  // Laser is read only.
  //  get_laser_status_srv_ = nh_.advertiseService<GetBoolRequest,
  //  GetBoolResponse>(
  ...
  get_ir_temperature_srv_ =
      nh_.advertiseService<GetDoubleRequest, GetDoubleResponse>(
          "get_ir_temperature", [this](auto &&request, auto &&response) {
            response.success =
                this->getIRTemperatureCallback(request, response);
            return response.success;
          });

  get_device_srv_ =
      nh_.advertiseService<GetDeviceInfoRequest, GetDeviceInfoResponse>(
          "get_device_info", [this](auto &&request, auto &&response) {
            response.success = this->getDeviceInfoCallback(request, response);
            return response.success;
          });
  get_sdk_version_srv_ =
      nh_.advertiseService<GetStringRequest, GetStringResponse>(
  ...
  switch_ir_camera_srv_ =
      nh_.advertiseService<SetStringRequest, SetStringResponse>(
          "switch_ir_camera", [this](auto &&request, auto &&response) {
            response.success = this->switchIRCameraCallback(request, response);
            return response.success;
          });
  get_camera_params_srv_ =
      nh_.advertiseService<GetCameraParamsRequest, GetCameraParamsResponse>(
...
bool OBCameraNode::setMirrorCallback(std_srvs::SetBoolRequest &request,
  ...
  if (!stream_started_[stream_index] ||
      !device_->hasSensor(stream_index.first)) {
    std::stringstream ss;
    ss << "Stream " << stream_name_[stream_index]
       << " is not started or does not have a sensor";
...
bool OBCameraNode::getExposureCallback(GetInt32Request &request,
  ...
  if (stream_index == COLOR) {
    ...
    if (camera_settings == nullptr) {
      ...
      response.message =
          stream_name_[stream_index] + " Camera settings not available";
      return false;
    }
...
bool OBCameraNode::setExposureCallback(SetInt32Request &request,
  ...
  if (stream_index == COLOR) {
    ...
    if (rc != openni::STATUS_OK) {
      ss << "Couldn't set color exposure: "
...
bool OBCameraNode::getGainCallback(GetInt32Request &request,
                                   GetInt32Response &response,
                                   const stream_index_pair &stream_index) {
  (void)request;
  if (!stream_started_[stream_index] ||
...
bool OBCameraNode::setGainCallback(SetInt32Request &request,
                                   SetInt32Response &response,
                                   const stream_index_pair &stream_index) {
  (void)response;
  if (!stream_started_[stream_index] ||
...
int OBCameraNode::getIRExposure() {
  ...
  int data_size = 4;
  std::lock_guard<decltype(device_lock_)> lock(device_lock_);
  device_->getProperty(OBEXTENSION_ID_IR_EXP, (uint32_t *)&data, &data_size);
  return data;
}

void OBCameraNode::setIRExposure(uint32_t data) {
  std::lock_guard<decltype(device_lock_)> lock(device_lock_);
  device_->setProperty(OBEXTENSION_ID_IR_EXP, data);
}
...
int OBCameraNode::getIRGain() {
  ...
  int data_size = 4;
  std::lock_guard<decltype(device_lock_)> lock(device_lock_);
  device_->getProperty(OBEXTENSION_ID_IR_GAIN, (uint8_t *)&data, &data_size);
  return data;
}
...
void OBCameraNode::setIRGain(int data) {
  int data_size = 4;
  std::lock_guard<decltype(device_lock_)> lock(device_lock_);
  device_->setProperty(OBEXTENSION_ID_IR_GAIN, (uint8_t *)&data, data_size);
}
...
bool OBCameraNode::getAutoWhiteBalanceEnabledCallback(
    GetInt32Request &request, GetInt32Response &response,
    const stream_index_pair &stream_index) {
  (void)request;
  if (!stream_started_[stream_index] ||
      !device_->hasSensor(stream_index.first)) {
...
bool OBCameraNode::setAutoWhiteBalanceEnabledCallback(
    SetInt32Request &request, SetInt32Response &response) {
  ...
  if (rc != openni::STATUS_OK) {
    std::stringstream ss;
    ss << " Couldn't set auto white balance: "
       << openni::OpenNI::getExtendedError();
    response.message = ss.str();
...
bool OBCameraNode::setAutoExposureCallback(
    std_srvs::SetBoolRequest &request, std_srvs::SetBoolResponse &response,
    const stream_index_pair &stream_index) {
  if (!stream_started_[stream_index] ||
      !device_->hasSensor(stream_index.first)) {
    std::stringstream ss;
...
bool OBCameraNode::getSDKVersionCallback(GetStringRequest &request,
  ...
  std::lock_guard<decltype(device_lock_)> lock(device_lock_);
  device_->getProperty(XN_MODULE_PROPERTY_SENSOR_PLATFORM_STRING, buffer,
                       &data_size);
...
bool OBCameraNode::getDeviceTypeCallback(GetStringRequest &request,
                                         GetStringResponse &response) {
  (void)request;
...
bool OBCameraNode::getSerialNumberCallback(GetStringRequest &request,
                                           GetStringResponse &response) {
  (void)request;
...
bool OBCameraNode::switchIRCameraCallback(SetStringRequest &request,
  ...
  if (request.data == "left") {
    data = 0;
    device_->setProperty(XN_MODULE_PROPERTY_SWITCH_IR, (uint8_t *)&data,
                         data_size);
...
bool OBCameraNode::getSupportedVideoModesCallback(
    GetStringRequest &request, GetStringResponse &response,
    const stream_index_pair &stream_index) {
  (void)request;
  if (!supported_video_modes_.count(stream_index)) {
    ...
    for (auto &mode : modes) {
      std::stringstream ss;
      ss << mode.getResolutionX() << "x" << mode.getResolutionY() << "@"
         << mode.getFps();
...
// bool OBCameraNode::getLaserStatusCallback(GetBoolRequest& request,
// GetBoolResponse& response) {
//   (void)request;
//   std::lock_guard<decltype(device_lock_)> lock(device_lock_);
//   int data = 0;
//   int data_size = 4;
//   device_->getProperty(XN_MODULE_PROPERTY_EMITTER_STATE, (uint8_t*)&data,
//   &data_size); response.data = data; return true;
// }

bool OBCameraNode::getLdpStatusCallback(GetBoolRequest &request,
                                        GetBoolResponse &response) {
  (void)request;
  std::lock_guard<decltype(device_lock_)> lock(device_lock_);
  int data = 0;
  int data_size = 4;
  device_->getProperty(XN_MODULE_PROPERTY_LDP_STATUS, (uint8_t *)&data,
                       &data_size);
  response.data = data;
  return true;
}
...
bool OBCameraNode::toggleSensor(const stream_index_pair &stream_index,
                                bool enabled, std::string &msg) {
  std::lock_guard<decltype(device_lock_)> lock(device_lock_);
